var closeArray = document.querySelector(".festivalNavBar-1");
var ganadaArray = document.querySelector(".festivalNavBar-2")
var newArray = document.querySelector(".festivalNavBar-3")
